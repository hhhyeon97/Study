package net.daum.service; // 컨트롤러와 dao를 연결하는 부분 
...
public class BoardServiceImpl implements BoardService {
	...
	public int getTotalCount() {
		return this.boardDao.getTotalCount(); //this.은 생략 가능
	}

	@Override
	public List<BoardVO> getBoardLsit(BoardVO b) {
	...
	public BoardVO getBoardCont(int bno) {
		...
		return this.boardDao.getBoardCont(bno); //번호에 해당하는 레코드 값 가져오기
	}
