...
@Table(name="tbl_boards2") // tbo_boards2 라는 테이블명을 지정 
public class BoardVO { // JPA에서 사용하는 엔티티빈 클래스 -> 이 클래스를 통해서 오라클 DB에 테이블과 시퀀스가 생성됨.
	...
	@CreationTimestamp // 하이버 네이트의 특별한 기능으로 게시물 등록 시점 날짜값을 기록
